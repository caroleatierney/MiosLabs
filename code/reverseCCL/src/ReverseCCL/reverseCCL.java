...
public class CircularSinglyLinkedList {	
	class Node {		// Define Node class
		...
		public Node(int data) {	// method to set the data on the node
			this.data = data;
		}
//	};
	...
	private class CircularSinglyLinkedList createCircularSinglyLinkedList() {		// method build a circular linked list and assign data values
